...
import com.why.project.recyclerfullymanagerdemo.manager.FullyGridLayoutManager;
...
public class FullyGridLayoutManagerActivity extends AppCompatActivity {
	...
	private void initDatas() {
		...
		gridLayoutManager.setRecyclerViewLayout((LinearLayout) findViewById(R.id.recycler_layout));
