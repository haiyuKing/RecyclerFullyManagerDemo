...
import com.why.project.recyclerfullymanagerdemo.manager.FullyLinearLayoutManager;
...
public class FullyLinearLayoutManagerActivity extends AppCompatActivity {
	...
	private void initDatas() {
		...
		linearLayoutManager.setRecyclerViewLayout((LinearLayout) findViewById(R.id.recycler_layout));
